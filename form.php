 ...
 */
    ...
    */
   define('CC_FB_SCRIPT_LAST_UPDATED', '12/08/2007');
    ...
    */   
   define('CC_FB_TO_EMAIL', 'recrutement.hh@free.fr');
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.headhunter31.com/thnx.html');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $auto_reply_msg = 'Thank you for e-mailing us.  We will reply as soon as possible.
';
